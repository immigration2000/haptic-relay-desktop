...
function formatLogMessage(message: string) {
  const messages: Record<string, string> = {
    ...
    'hardware-control-signals-configured': '직렬 제어선 설정 완료',
    'hardware-control-signals-failed': '직렬 제어선 설정 실패',
    'hardware-readiness-failed': 'T-Code 준비 확인 실패',
    'hardware-ready': 'T-Code 통신 준비 완료',
...
function formatReason(reason: string) {
  const messages: Record<string, string> = {
    ...
    'hardware-not-ready': '하드웨어 통신 준비가 완료되지 않았습니다',
    'hardware-tcode-not-ready': 'T-Code 응답을 확인하지 못해 연결을 종료했습니다',
    'hardware-control-signals-failed': '직렬 제어선 설정에 실패하여 연결을 종료했습니다',
    'hardware-control-signals-timeout': '직렬 제어선 설정 시간이 초과되어 연결을 종료했습니다',
