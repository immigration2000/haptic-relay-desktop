...
export function setOutputLogFollowing(model: OutputLogModel, following: boolean): OutputLogModel;
...
export function canExpandHistory(model: OutputLogModel): boolean;
